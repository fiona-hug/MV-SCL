...
def make_args():
    ...
    parser.add_argument('--seed', type = int, default=4, metavar='int', help='random seed')#delp4
    parser.add_argument('--decay', type = float, default=0.97, metavar='LR_decay', help='decay')
    parser.add_argument('--lr', type = float, default=0.055, metavar='LR', help='learning rate')#dblp0.055
    ...
    parser.add_argument('--ssl_reg', type  = float, default=0.02)
    parser.add_argument('--ssl_uSamp', type = int, default=512)
    parser.add_argument('--ssl_iSamp', type = int, default=512)

    #软对比学习
    parser.add_argument('--tau_inst', type=float, default=6)#6
    parser.add_argument('--alpha', type=float, default=0.5)#0.5
    parser.add_argument('--ssl_uneg', type = float, default=0.045)#0。045
    parser.add_argument('--ssl_ineg', type = float, default=0.045)#0.02
